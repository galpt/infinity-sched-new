...
> [!TIP]
> For CachyOS users, the CachyOS Kernel Manager can be used to build the kernel easily with the Infinity patches applied. The patches were tested against 7.2.6-1 initially. You may open a new [Issue](https://github.com/galpt/infinity-sched-new/issues) if you need patches for other kernel versions.
